...
Route::middleware(['auth', \App\Http\Middleware\CheckSuspendedUser::class])->group(function () {
    ...
    Route::get('/admin/coo/staff-dashboard', [\App\Http\Controllers\CooStaffDashboardController::class, 'index'])->name('coo.staff_dashboard');
    ...
    Route::post('/admin/projects/{id}/update-doc-remark', [ProjectController::class, 'updateDocRemark'])->name('projects.update_doc_remark');
    Route::post('/admin/projects/{id}/site-study', [ProjectController::class, 'updateSiteStudy'])->name('projects.update_site_study');
