...
@section('content')
    ...
    <div style="margin-bottom: 1.5rem; display: flex; align-items: center; justify-content: space-between;">
        ...
        <h3 style="color: #ffffff; font-size: 1.25rem; font-weight: 600;">Approved General Registry</h3>
    </div>
            ...
            <table class="table-custom">
                <thead>
                    ...
                    <tr>
                        ...
                        <th>Name</th>
                        <th>Panchayath</th>
                        <th style="border-right: 2px solid #2a3547;">Type of Application</th>
                        <th>Project ID</th>
                ...
                <tbody>
                    @forelse($applications as $appItem)
                        ...
                        <tr class="app-row" data-search="{{ $searchStr }}" data-place="{{ $appItem->place ?? '' }}">
                            ...
                            <td style="border-right: 2px solid #2a3547;">{{ $meta['office_application_type'] ?? '-' }}</td>
                            <!-- Project ID & Status -->
                            <td>
                                @if($project)
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                    <div>
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                            ...
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.5rem 0; font-weight: 600;">Type:</td><td>\${formatVal(meta.office_application_type)}</td></tr>
                        </table>
                    </div>
                </div>
            `;
