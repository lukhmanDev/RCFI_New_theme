...
<body>
    ...
    <div class="login-card">
        ...
        <!-- Status Messages -->
        @if (session('status'))
            <div class="alert-success" style="background-color: rgba(16, 185, 129, 0.05); border: 1px solid var(--accent-green); color: var(--accent-green); padding: 0.75rem; border-radius: 8px; font-size: 0.85rem; margin-bottom: 1.5rem; font-weight: 500;">
                {{ session('status') }}
            </div>
        @endif
