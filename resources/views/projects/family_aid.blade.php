                ...
                @forelse($projects as $index => $project)
                    ...
                    <tr class="project-row" data-search="{{ $searchString }}">
                        ...
                        <td style="text-align: center; white-space: nowrap;">
                            ...
                            <!-- PDF Report Button -->
                            <a href="{{ route('admin.reports.single_project', [$project->id, 'category' => 'family-aid']) }}?print=1" target="_blank" class="btn-action-icon btn-pdf" title="PDF / Print Report">
...
<script>
    ...
    window.openAddProgrammeModal = function openAddProgrammeModal(project) {
        ...
        form.action = `/admin/projects/family-aid/${project.id}/add-programme`;
