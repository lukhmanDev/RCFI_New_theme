...
<div class="controls-row">
    <div style="display: flex; gap: 0.75rem;">
        ...
        <a href="{{ route('projects.export', 'family-aid') }}" id="excelExportBtn" class="excel-export-btn btn-custom" style="background: linear-gradient(135deg, #2ecc71, #27ae60); text-decoration: none;">
...
<div class="modal-overlay" id="addProjectModal">
    <div class="modal-content-custom">
        ...
        <form action="{{ route('projects.store') }}" method="POST">
            @csrf
            <input type="hidden" name="redirect_category" value="family-aid">
            ...
            <div class="modal-body-custom">
                ...
                <div class="form-group-custom">
                    ...
                    <input type="text" value="Family Aid" disabled style="background-color: var(--bg-color); border: 1px solid var(--panel-border); color: var(--text-muted);">
                    <input type="hidden" name="type_of_project" value="Family Aid">
                </div>
        ...
        <form id="addProgrammeForm" method="POST" action="" onsubmit="handleAddProgrammeSubmit(event); return false;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                <div style="grid-column: span 2;">
                    ...
                    <select name="programme_name" id="family_add_prog_name_select" required class="form-control-dark" style="width: 100%; padding: 0.6rem 0.8rem; border-radius: 6px; border: 1px solid var(--panel-border); background-color: var(--bg-color); color: #ffffff;" onchange="if(typeof toggleSpecifyProgrammeField === 'function') toggleSpecifyProgrammeField(this, 'family_add_prog_other_name_wrapper', 'family_add_prog_other_name_input')">
                ...
                <div id="family_add_prog_other_name_wrapper" style="grid-column: span 2; display: none;">
                    ...
                    <input type="text" id="family_add_prog_other_name_input" name="other_programme_name" placeholder="Enter custom programme name..." class="form-control-dark" style="width: 100%; padding: 0.6rem 0.8rem; border-radius: 6px; border: 1px solid var(--panel-border); background-color: var(--bg-color); color: #ffffff;">
                </div>
                <div>
