...
<div style="margin-bottom: 1.5rem; display: flex; align-items: center; justify-content: space-between;">
    ...
    <h3 style="color: #ffffff; font-size: 1.25rem; font-weight: 600;">General Project Registry</h3>
</div>
...
<div class="controls-row">
    <div style="display: flex; gap: 0.75rem;">
        <a href="{{ route('projects.export', 'general') }}" class="btn-custom" style="background: linear-gradient(135deg, #2ecc71, #27ae60); text-decoration: none;">
    ...
    <div style="overflow-x: auto;">
        <table class="table-custom" id="projectsTable">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="9" style="text-align: center; padding: 2rem; color: var(--text-muted);">No general projects registered yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
