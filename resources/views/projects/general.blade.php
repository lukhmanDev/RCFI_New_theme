...
<div class="controls-row">
    <div style="display: flex; gap: 0.75rem;">
        ...
        <a href="{{ route('projects.export', 'general') }}" id="excelExportBtn" class="excel-export-btn btn-custom" style="background: linear-gradient(135deg, #2ecc71, #27ae60); text-decoration: none;">
