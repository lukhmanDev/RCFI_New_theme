                ...
                @forelse($projects as $index => $project)
                    <tr>
                        ...
                        <td style="text-align: center; white-space: nowrap;">
                            ...
                            <!-- PDF Report Button -->
                            <a href="{{ route('admin.reports.single_project', [$project->id, 'category' => 'drinking-water-group-level']) }}?print=1" target="_blank" class="btn-action-icon btn-pdf" title="PDF / Print Report">
