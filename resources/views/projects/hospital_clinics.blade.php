...
<div style="margin-bottom: 1.5rem; display: flex; align-items: center; justify-content: space-between;">
    ...
    <h3 style="color: #ffffff; font-size: 1.25rem; font-weight: 600;">Hospital or Clinics Project Registry</h3>
</div>
...
<div class="group-header-panel">
    Hospital or Clinics PROJECT LIST
</div>
    ...
    <div style="overflow-x: auto;">
        <table class="table-custom" id="projectsTable">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="9" style="text-align: center; padding: 2rem; color: var(--text-muted);">No hospital or clinics projects registered yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
