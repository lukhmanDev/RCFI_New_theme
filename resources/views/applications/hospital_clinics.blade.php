...
@section('content')
    ...
    <div style="margin-bottom: 1.5rem; display: flex; align-items: center; justify-content: space-between;">
        ...
        <h3 style="color: #ffffff; font-size: 1.25rem; font-weight: 600;">Hospital or Clinics Registry</h3>
    </div>
                ...
                <tbody>
                    @forelse($applications as $appItem)
                        ...
                        <tr>
                            ...
                            <td class="col-location">{{ $meta['place'] ?? $meta['location'] ?? 'N/A' }}</td>
                            ...
                            <td class="col-contact1">{{ $meta['mobile'] ?? $meta['contact_number_1'] ?? 'N/A' }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="18" style="text-align: center; padding: 2rem;">No hospital or clinic applications registered yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div id="addAppModal" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(0, 0, 0, 0.75); display: none; align-items: center; justify-content: center; z-index: 1000; overflow-y: auto;" onclick="closeModal()">
        <div class="panel" style="width: 100%; max-width: 700px; margin: 2rem auto; position: relative; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5); border-color: #2a3547; max-height: 90vh; overflow-y: auto;" onclick="event.stopPropagation()">
            ...
            <form action="{{ route('applications.store') }}" method="POST">
                ...
                <div style="border-bottom: 1px solid var(--panel-border); padding-bottom: 1rem; margin-bottom: 1.5rem;">
                    <h4 style="color: var(--accent-cyan); font-size: 0.95rem; margin-bottom: 1rem; text-transform: uppercase; font-weight: 700; letter-spacing: 0.05em;">2. Project Site Description</h4>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                        <div>
                            <label class="form-label" for="site_has_building">Is there a building at present? *</label>
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem; margin-bottom: 1rem;">
                        <div>
                            <label class="form-label" for="permitted_type">Permitted Type *</label>
        ...
        <div class="panel" style="width: 100%; max-width: 700px; margin: 2rem auto; position: relative; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5); border-color: #2a3547; max-height: 90vh; overflow-y: auto;" onclick="event.stopPropagation()">
            ...
            <form id="editAppForm" action="" method="POST">
                ...
                <div style="border-bottom: 1px solid var(--panel-border); padding-bottom: 1rem; margin-bottom: 1.5rem;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                        <div>
                            <label class="form-label" for="edit_site_has_building">Is there a building at present? *</label>
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem; margin-bottom: 1rem;">
                        <div>
                            <label class="form-label" for="edit_permitted_type">Permitted Type *</label>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                    ...
                    <div>
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                            ...
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.5rem 0; font-weight: 600;">State:</td><td>${formatVal(meta.locality_state)}</td></tr>
                    ...
                    <div>
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                            ...
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.5rem 0; font-weight: 600;">Permitted Type:</td><td>${formatVal(meta.permitted_type)}</td></tr>
