    ...
    <div class="panel" style="width: 100%;">
        ...
        <div style="overflow-x: auto;">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 2rem;">No cultural center applications registered yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1rem;">
                        ...
                        <div>
                            ...
                            <input type="number" step="any" min="0" class="form-control-dark" id="land_area_sq" name="meta[land_area_sq]" value="{{ old('meta.land_area_sq') }}" required>
                        </div>
                    </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <div>
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                            ...
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.45rem 0; font-weight: 600;">CC Nearby?</td><td>${formatVal(meta.cultural_center_nearby || meta.education_center_nearby)}</td></tr>
                            ${(meta.cultural_center_nearby || meta.education_center_nearby || '').toLowerCase() === 'yes' || meta.distance_cultural_centre ? `<tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.45rem 0; font-weight: 600;">Distance to CC (KM):</td><td>${formatVal(meta.distance_cultural_centre)}</td></tr>` : ''}
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.45rem 0; font-weight: 600;">Benefited Households:</td><td>${formatVal(meta.benefited_households)}</td></tr>
                        </table>
                    </div>
                    ...
                    <div>
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                            ...
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.45rem 0; font-weight: 600;">Beneficiary:</td><td>${formatVal(meta.num_beneficiaries || meta.benefited_households)} households</td></tr>
