...
@section('content')
    ...
    <script>
        ...
        function updateRealtimeApplicationDetails(selectedId) {
            ...
            const centerNearby = formatVal(getVal(['cultural_center_nearby', 'education_center_nearby']));
            const distanceCc = formatVal(getVal(['distance_cultural_centre', 'distance_education_center']));
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                    ...
                    <div>
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem; color: var(--text-main);">
                            ...
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.5rem 0; font-weight: 600; color: var(--text-muted);">Distance to CC (KM):</td><td>${distanceCc}</td></tr>
