...
@section('content')
    ...
    <script>
        ...
        function updateRealtimeApplicationDetails(selectedId) {
            ...
            const numRooms = formatVal(getVal(['num_rooms', 'rooms']));
            const officeShop = formatVal(getVal(['office_shop']));
            const permittedType = formatVal(getVal(['permitted_type']));
            ...
            container.innerHTML = `
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                    ...
                    <!-- Col 2 -->
                    <div>
                        <h4 style="color: var(--accent-cyan); border-bottom: 1px solid var(--panel-border); padding-bottom: 0.5rem; margin-bottom: 0.75rem; font-size: 0.9rem; font-weight: 700; text-transform: uppercase;">3. Current Status & Shop Details</h4>
                        <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem; color: var(--text-main);">
                            ...
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.5rem 0; font-weight: 600; color: var(--text-muted);">Rooms Count:</td><td>${numRooms}</td></tr>
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.5rem 0; font-weight: 600; color: var(--text-muted);">Office / Shop:</td><td>${officeShop}</td></tr>
                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.02);"><td style="padding: 0.5rem 0; font-weight: 600; color: var(--text-muted);">Permitted Type:</td><td>${permittedType}</td></tr>
                        </table>
