...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        $categoryFields = [
            ...
            'hospital_clinic_applications' => ['area', 'building_area_sq', 'committee_name', 'contact_number_1', 'contact_number_2', 'district', 'estimated_amount', 'families_in_mahallu', 'is_pharmacy', 'legal_approvals_status', 'locality_location', 'locality_state', 'locality_village', 'mahallu_name', 'mobile', 'num_beds', 'panchayat', 'panchayath', 'permitted_type', 'place', 'post', 'project_area', 'reg_number', 'requirement', 'rooms', 'site_has_building', 'state', 'village', 'year'],
            ...
            'shop_other_applications' => ['area', 'building_area_sq', 'committee_name', 'contact_number_1', 'contact_number_2', 'district', 'estimated_amount', 'families_in_mahallu', 'legal_approvals_status', 'locality_district', 'locality_location', 'locality_state', 'locality_village', 'mahallu_name', 'mobile', 'num_rooms', 'office_shop', 'panchayat', 'panchayath', 'permitted_type', 'place', 'post', 'project_area', 'reg_number', 'rooms', 'site_has_building', 'state', 'status_of_current_building', 'village', 'year'],
        ];
